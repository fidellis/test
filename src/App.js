  ...
  return (
    <div className="teste">
      <ExportDataTable 
          ...
          columns={columns}
          width="90%"
          actions={[{ label: 'Teste'}, { label: 'Teste 2'}, { label: 'Teste 3'}, { label: 'Teste 4'}, `${rows.length} registros`]}
          title={<h3>Teste data table Teste data table</h3>}
          footerHeight={50}
          // maxHeight={500}
